...
if CLIENT then
   SWEP.PrintName          = "#tttwfs_newton_name"
   SWEP.Instructions       = "#tttwfs_newton_desc0\n\n#tttwfs_newton_desc1\n#tttwfs_newton_desc2"
   SWEP.Slot               = 4
   SWEP.SlotPos            = 4
   ...
   SWEP.IconOverride       = "vgui/entities/tttws_push.png"
end
...
function SWEP:DrawWeaponSelection( x, y, wide, tall, alpha )
   ...
   draw.SimpleText( "h", "HL2SelectIcons", xPos, yPos, Color( 255, 250, 0, 255 ), TEXT_ALIGN_CENTER )
   draw.SimpleText( "h", "HL2SelectIcons2", xPos, yPos, Color( 255, 250, 0, 255 ), TEXT_ALIGN_CENTER )
