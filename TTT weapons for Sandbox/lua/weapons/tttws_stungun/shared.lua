...
if CLIENT then
   SWEP.PrintName          = "#tttwfs_stungun_name"
   SWEP.Instructions       = "#tttwfs_ump_desc0\n#tttwfs_ump_desc1\n\n#tttwfs_ump_desc2"
   SWEP.Slot               = 2
   SWEP.SlotPos            = 5
   ...
   SWEP.IconOverride       = "vgui/entities/tttws_stungun.png"
end
...
function SWEP:DrawWeaponSelection( x, y, wide, tall, alpha )
   ...
   draw.SimpleText( "q", "TTTSelectIcons", xPos, yPos, Color( 255, 250, 0, 255 ), TEXT_ALIGN_CENTER )
   draw.SimpleText( "q", "TTTSelectIcons2", xPos, yPos, Color( 255, 250, 0, 255 ), TEXT_ALIGN_CENTER )
