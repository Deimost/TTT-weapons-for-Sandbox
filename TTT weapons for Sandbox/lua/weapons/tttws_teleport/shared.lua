...
if CLIENT then
   SWEP.PrintName             = "#tttwfs_tele_name"
   SWEP.Purpose               = "#tttwfs_tele_desc0\n#tttwfs_tele_desc1\n#tttwfs_tele_desc2"
   SWEP.Instructions          = "#tttwfs_tele_desc3\n#tttwfs_tele_desc4\n#tttwfs_tele_desc5"
   SWEP.Slot               = 0
   SWEP.SlotPos            = 5
   ...
   SWEP.IconOverride       = "vgui/entities/tttws_teleport.png"
end
...
function SWEP:DrawWeaponSelection( x, y, wide, tall, alpha )
   ...
   draw.SimpleText( "T", "TTTSelectIcons", xPos, yPos, Color( 255, 250, 0, 255 ), TEXT_ALIGN_CENTER )
   draw.SimpleText( "T", "TTTSelectIcons2", xPos, yPos, Color( 255, 250, 0, 255 ), TEXT_ALIGN_CENTER )
...
local tttws_telefrags = CreateConVar("tttws_teleport_telefrags", "1")
...
local function DoTeleport(ply, teleport, weapon)
   if IsValid(ply) and teleport then
      ...
      elseif block_plys and #block_plys > 0 then
         ...
         if tttws_telefrags:GetBool() then
