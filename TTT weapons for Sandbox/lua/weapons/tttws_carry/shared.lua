...
if CLIENT then
   SWEP.PrintName             = "#tttwfs_magnet_name"
   SWEP.Instructions          = "#tttwfs_magnet_help"
   SWEP.Slot               = 0
   SWEP.SlotPos            = 5
   ...
   SWEP.IconOverride       = "vgui/entities/tttws_carry.png"
end
...
function SWEP:DrawWeaponSelection( x, y, wide, tall, alpha )
   ...
   draw.SimpleText("n", "HL2SelectIcons", xPos, yPos, Color( 255, 250, 0, 255 ), TEXT_ALIGN_CENTER )
   draw.SimpleText("n", "HL2SelectIcons2", xPos, yPos, Color( 255, 250, 0, 255 ), TEXT_ALIGN_CENTER )
...
local allow_rag  = CreateConVar("tttws_ragdoll_carrying", "1")
local prop_force = CreateConVar("tttws_prop_carrying_force", "60000")
local no_throw   = CreateConVar("tttws_no_prop_throwing", "0")
local pin_rag    = CreateConVar("tttws_ragdoll_pinning", "1")
local pin_rag_inno = CreateConVar("tttws_ragdoll_pinning_innocents", "0")
...
local allow_wep = CreateConVar("tttws_weapon_carrying", "0")
local wep_range = CreateConVar("tttws_weapon_carrying_range", "50")
