...
if CLIENT then
   SWEP.PrintName          = "#tttwfs_knife_name"
   SWEP.Instructions       = "#tttwfs_knife_desc0\n#tttwfs_knife_desc1\n\n#tttwfs_knife_desc2\n#tttwfs_knife_desc3"
   SWEP.Slot               = 0
   SWEP.SlotPos            = 5
   ...
   SWEP.IconOverride       = "vgui/entities/tttws_knife.png"
end
...
function SWEP:DrawWeaponSelection( x, y, wide, tall, alpha )
   ...
   draw.SimpleText( "j", "TTTSelectIcons", xPos, yPos, Color( 255, 250, 0, 255 ), TEXT_ALIGN_CENTER )
   draw.SimpleText( "j", "TTTSelectIcons2", xPos, yPos, Color( 255, 250, 0, 255 ), TEXT_ALIGN_CENTER )
...
function SWEP:StabKill(tr, spos, sdest)
   ...
   target.effect_fn = function(rag)
                         ...
                         rag:CallOnRemove("tttws_knife_cleanup", function() SafeRemoveEntity(knife) end)
                      end
...
function SWEP:SecondaryAttack()
   ...
   if SERVER then
      ...
      local knife = ents.Create("tttws_knife_proj")
